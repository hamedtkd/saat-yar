...
- [ ] فاز ۱۳۰: تعمیم الگوی ساخت وابسته به رابطه‌های مالی/ثبت زمان، از جمله Invoice → Client/Project و Timer/Expense → Project، همراه با Empty State و انتخاب خودکار.
