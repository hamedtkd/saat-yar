...
- [ ] فاز ۱۰۲: تثبیت App Shell، Header، Sidebar و Bottom Navigation در دسکتاپ و موبایل.
- [ ] فاز ۱۰۳: گسترش زبان طراحی نهایی به ماه، گزارش، تنظیمات، مرخصی و صفحات مالی.
- [ ] فاز ۱۰۴: تکمیل UX نصب PWA، وضعیت Offline، Update Prompt و تست نصب‌پذیری.
- [ ] فاز ۱۰۵: تولید Screenshot و GIF فقط پس از Design Freeze.
