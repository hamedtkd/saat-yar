...
- [ ] فاز ۱۰۴: گسترش زبان طراحی نهایی به ماه، گزارش، تنظیمات، مرخصی و صفحات مالی.
- [ ] فاز ۱۰۵: تکمیل UX نصب PWA، وضعیت Offline، Update Prompt و تست نصب‌پذیری.
- [ ] فاز ۱۰۶: تولید Screenshot و GIF فقط پس از Design Freeze.
...
- [ ] انتقال زبان طراحی نهایی به ماه، گزارش‌ها، تنظیمات، مرخصی، مشتری‌ها، پروژه‌ها و فاکتورها.
- [ ] تکمیل تجربه PWA شامل نصب، وضعیت آفلاین و اعلان نسخه جدید.
- [ ] تولید اسکرین‌شات‌ها و GIFهای نهایی بعد از Design Freeze.

## قابلیت‌های پس از Design Freeze

- [ ] فاز ۱۱۰: طراحی قرارداد و Schema موتور محاسبه حقوق قابل‌سفارشی‌سازی با Presetهای ماهانه، ساعتی، روزکاری و ترکیبی.
- [ ] فاز ۱۱۱: افزودن UI فرمول حقوق، Preview و Breakdown شفاف در گزارش‌ها با حفظ Backup/Migration.
- [ ] فاز ۱۱۲: طراحی پروتکل انتقال دستگاه‌به‌دستگاه با Payload نسخه‌دار، Merge/Replace، Conflict Preview و رمزنگاری session.
- [ ] فاز ۱۱۳: Pairing سریع موبایل و لپ‌تاپ با QR و WebRTC DataChannel بدون دیتابیس دائمی؛ با fallback دوطرفه QR/کد دستی در نبود Signaling.
