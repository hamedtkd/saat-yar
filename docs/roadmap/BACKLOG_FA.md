...
- [ ] فاز ۱۰۷: انتقال زبان طراحی نهایی به مرخصی، مشتری‌ها، پروژه‌ها و فاکتورها.
- [ ] فاز ۱۰۸: تکمیل UX نصب PWA، وضعیت Offline، Update Prompt و تست نصب‌پذیری.
- [ ] فاز ۱۰۹: تولید Screenshot و GIF فقط پس از Design Freeze.
...
- [ ] انتقال زبان طراحی نهایی به مرخصی، مشتری‌ها، پروژه‌ها و فاکتورها.
