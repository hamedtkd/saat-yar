  ...
  return (
    <input
      ...
      className={cn(
        ...
        "hover:border-[color-mix(in_srgb,var(--accent)_28%,var(--border))] focus-visible:border-[var(--accent)] focus-visible:ring-4 focus-visible:ring-[var(--accent-soft)] disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
