...
export function AppHeader(props: Props) {
  ...
  return <header className={cn("sticky top-3 z-30 flex min-h-[60px] items-center justify-between gap-3 rounded-[var(--card-radius)] border border-[var(--border)] bg-[var(--surface-glass)] px-4 shadow-[0_6px_20px_rgba(0,0,0,.035)] backdrop-blur-xl xl:mr-[264px]", "max-[640px]:top-2 max-[640px]:min-h-14 max-[640px]:rounded-2xl max-[640px]:px-3")}>
