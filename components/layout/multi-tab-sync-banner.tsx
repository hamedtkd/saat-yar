...
export function MultiTabSyncBanner({ pending, onReload, onDismiss }: {
  ...
  return (
    <section className="mx-auto mb-4 flex max-w-[1510px] flex-wrap items-center justify-between gap-3 rounded-[var(--card-radius)] border border-[color-mix(in_srgb,var(--warning)_32%,var(--border))] bg-[var(--warning-soft)] px-4 py-3 text-[var(--text)] xl:mr-[264px]" role="status" aria-live="polite">
