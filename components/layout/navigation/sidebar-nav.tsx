  ...
  return (
    <aside className="fixed inset-y-3 right-3 z-40 hidden w-[248px] flex-col rounded-[var(--card-radius)] border border-[var(--border)] bg-[var(--surface-1)] p-3 shadow-[0_10px_32px_rgba(0,0,0,.055)] xl:flex">
      ...
      <div className="mt-auto border-t border-[var(--border)] pt-3">
        <Link href="/settings" aria-current={currentPath === "/settings" ? "page" : undefined} className={cn("flex min-h-11 items-center gap-3 rounded-[var(--control-radius)] px-3 text-sm font-bold text-[var(--text-muted)] hover:bg-[var(--accent-soft)] hover:text-[var(--text)]", currentPath === "/settings" && "bg-[var(--accent-soft)] text-[var(--accent-strong)]")}>
