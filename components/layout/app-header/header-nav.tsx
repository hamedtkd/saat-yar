...
export function HeaderNav({ mode, currentPath }: { mode: Mode; currentPath: string }) {
  return (
    <nav className={cn(
      ...
      "max-[900px]:fixed max-[900px]:inset-x-[7px] max-[900px]:bottom-[calc(7px+env(safe-area-inset-bottom))] max-[900px]:z-50 max-[900px]:h-16 max-[900px]:justify-around max-[900px]:rounded-[15px] max-[900px]:border max-[900px]:border-[#dfe7e9] max-[900px]:bg-white/95 max-[900px]:p-1 max-[900px]:shadow-[0_-8px_30px_rgba(17,45,55,0.08)] max-[900px]:backdrop-blur-xl",
      "[&_a]:relative [&_a]:inline-flex [&_a]:min-w-[86px] [&_a]:items-center [&_a]:justify-center [&_a]:gap-2 [&_a]:font-bold [&_a]:text-[#102a3a] [&_a]:transition-colors",
      "[&_a_svg]:h-5 [&_a_svg]:w-5 [&_a_svg]:shrink-0 [&_a_svg]:stroke-[1.8] [&_a.active]:text-[#079b60]",
      "[&_a]:after:absolute [&_a]:after:inset-x-3 [&_a]:after:bottom-0 [&_a]:after:h-[3px] [&_a]:after:rounded-t-lg [&_a]:after:bg-transparent [&_a]:after:content-[''] [&_a.active]:after:bg-[#079b60]",
