...
export function RestoreCard({ previewImport, importPreview, applyImport }: {
  ...
  return (
    <section className={cn("dashboard-card rounded-[var(--card-radius)] border border-[var(--dashboard-border)] shadow-[0_5px_16px_rgba(0,0,0,.03)] p-4", "p-5", "col-span-full max-[620px]:col-auto")}>
