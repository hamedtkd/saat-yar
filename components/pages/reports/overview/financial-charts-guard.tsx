...
export function FinancialChartsGuard({ hidden, children }: FinancialChartsGuardProps) {
  ...
  return (
    <SurfaceCard as="section" className="mb-4 grid min-h-40 place-items-center border-dashed p-6 text-center">
      <div>
        <strong className="block text-sm text-[#102a3a]">نمودارهای مالی مخفی هستند</strong>
        <span className="mt-1 block text-[10px] text-[#6c7d89]">برای نمایش درآمد و مبالغ، دکمه چشم در نوار بالا را بزن.</span>
      </div>
    </SurfaceCard>
  );
}
