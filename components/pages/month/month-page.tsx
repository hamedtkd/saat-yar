  ...
  return <>
    ...
    <section className="mb-5" data-month-intelligence-section>
      ...
      <div className="grid items-stretch grid-cols-[minmax(340px,.95fr)_minmax(300px,.78fr)_minmax(340px,1fr)] gap-4 max-[1180px]:grid-cols-1 max-[1180px]:[&>article]:h-auto">
        <ActivityHeatmap selectedDate={selectedDate} setSelectedDate={setSelectedDate} data={data} />
        <RecentActivityCard selectedDate={selectedDate} setSelectedDate={setSelectedDate} data={data} />
        <MonthIntelligenceCard selectedDate={selectedDate} data={data} />
      </div>
    </section>
