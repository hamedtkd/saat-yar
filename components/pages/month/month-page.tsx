...
export function MonthPage({ data, selectedDate, setSelectedDate, monthRecords, monthStats, dailyTarget }: {
  ...
  return <>
    <PageHeading title="ماه من" description="نمای شمسی کارکرد، وقفه، مرخصی و تراز روزانه."><div className={cn("flex items-center gap-[9px] max-[620px]:flex-wrap")}><Button variant="outline" onClick={exportMonth}><Download /> خروجی CSV</Button><JalaliDatePicker value={selectedDate} onChange={setSelectedDate} recordedDates={Object.keys(data.records)} /></div></PageHeading>
