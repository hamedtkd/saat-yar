...
export function MonthPage({ data, selectedDate, setSelectedDate, monthRecords, monthStats }: {
  ...
  return <>
    ...
    <section className="mb-5 grid grid-cols-[minmax(0,1.55fr)_minmax(300px,.45fr)] gap-5 max-[980px]:grid-cols-1">
    ...
    <div className="mb-5"><MonthDayDetails data={data} selectedDate={selectedDate} /></div>
