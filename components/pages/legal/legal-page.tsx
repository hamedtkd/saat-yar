...
export function LegalPage({ kind }: { kind: "privacy" | "terms" }) {
  ...
  return <div className="grid gap-5" data-public-legal-page>
    <PageHeading autosave={false} title={page.title} description={page.summary} />
    <section className="dashboard-card grid gap-5 rounded-[var(--card-radius)] border border-[var(--dashboard-border)] p-5 sm:p-6">
      ...
      {page.sections.map((section) => <article key={section.title} className="grid max-w-4xl gap-2">
