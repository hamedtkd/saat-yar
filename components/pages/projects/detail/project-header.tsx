...
export function ProjectHeader({ project, client, activeEntry, onBack, onToggleTimer, onToggleStatus }: {
  ...
  return (
    <section className={cn(
      ...
      "[&_h1]:mt-2 [&_h1]:flex [&_h1]:items-center [&_h1]:gap-2.5 [&_h1]:text-[clamp(26px,2.4vw,36px)] [&_p]:text-[13px] [&_p]:text-[#6c7d89]",
    )}>
      <div className="min-w-0">
        <button type="button" className="flex items-center gap-1 bg-transparent p-0 text-[#079b60]" onClick={onBack}>
