...
export function AppLoadingState({ label, logoLabel, pathname }: Props) {
  return (
    <main
      ...
      aria-busy="true"
      aria-live="polite"
      className="dashboard-shell min-h-screen w-full min-w-0 overflow-hidden bg-[var(--page)] p-2 pb-28 sm:p-3 sm:pb-28 xl:px-0 xl:pb-3"
    >
      ...
      <div className="shell-main-offset mx-auto w-full min-w-0 px-1 pb-6 pt-4 sm:px-3 sm:pt-5 lg:px-5">
      ...
      <div aria-hidden="true" className="fixed bottom-[calc(8px+env(safe-area-inset-bottom))] left-1/2 grid h-[64px] w-[calc(100vw-16px)] max-w-[520px] -translate-x-1/2 grid-cols-5 gap-1 rounded-[21px] border border-[var(--dashboard-border)] bg-[var(--surface-glass)] p-1 shadow-[0_10px_30px_rgba(0,0,0,.16)] xl:hidden">
