...
## تعطیلات رسمی و محاسبه کارکرد روز تعطیل

ساعت‌یار می‌تواند تعطیلات رسمی و جمعه‌ها را به‌صورت خودکار تشخیص دهد. روزهای تعطیل در تقویم با رنگ قرمز نمایش داده می‌شوند، هدف کاری آن روز صفر است و در صورت ثبت کارکرد، مبلغ روز با «ضریب روز تعطیل» تنظیمات محاسبه می‌شود.

- داده‌های متغیر مذهبی سال ۱۴۰۵ در پروژه قرار گرفته‌اند.
- تعطیلات ثابت شمسی برای سال‌های دیگر نیز شناسایی می‌شوند.
- ۱۱ اردیبهشت برای حالت کارمند و ترکیبی به‌عنوان روز کارگر در نظر گرفته می‌شود.
- کاربر همچنان می‌تواند یک روز را به‌صورت دستی تعطیل ثبت کند.
- تعطیلی‌های موردی و استانی که پس از انتشار تقویم رسمی اعلام می‌شوند باید به‌صورت دستی ثبت شوند.

مرجع اصلی بررسی تقویم سالانه، مرکز تقویم مؤسسه ژئوفیزیک دانشگاه تهران است.
