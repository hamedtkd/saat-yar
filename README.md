...
The verified Phase 178 baseline at `887158c` passed **758/758 tests**. Phase 179 candidate `1cabdb4` completed the **764/764** gate, and Phase 180 added six finalization contracts for a **770/770** final gate. The released 2.4.0 data contract stays immutable on schema v17. Post-release development is currently on **schema v19** for flexible work/activity segments and notification intelligence. Phase 184 adds privacy-safe, explicit-opt-in product analytics without changing AppData: consent stays browser-local, event properties are allowlisted, and no analytics transport is active unless a provider is configured at build time. See the [2.4.0 release notes](./docs/releases/RELEASE_NOTES_2.4.0_EN.md), [Phase 184 notes](./docs/phases/PHASE_184_NOTES_FA.md), and the [roadmap](./docs/roadmap/BACKLOG_FA.md).
