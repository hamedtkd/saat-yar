...
- جایگزینی پیاده‌سازی دستی Alert Dialog با Primitive رسمی Radix.
- Focus trap، مدیریت Escape، جلوگیری از تعامل بیرونی و بازگشت Focus به کتابخانه رسمی واگذار شد.
- API و استایل RTL فعلی برای تمام تأییدهای مخرب و هشدارهای ناوبری حفظ شد.
...
- گزارش خوانای اختلاف قرارداد `AppData` با مسیر شکست، نسخه Schema و دسته‌بندی Missing/Unexpected/Invalid در CI
