...
Baseline فاز ۱۷۸ روی `887158c` با **۷۵۸/۷۵۸ تست** بسته شد. Candidate فاز ۱۷۹ روی `1cabdb4` Gate **۷۶۴/۷۶۴** را کامل کرد و فاز ۱۸۰ با شش قرارداد Finalization به Gate نهایی **۷۷۰/۷۷۰** رسید. قرارداد منتشرشده ۲.۴.۰ به‌صورت immutable روی Schema v17 باقی می‌ماند. توسعه پس از Release اکنون روی **Schema v19** است: فاز ۱۸۲ Target مستقل روزانه و Activity Segment، فاز ۱۸۳ Notification Intelligence، فاز ۱۸۴ Analytics حریم‌خصوصی‌محور بدون گسترش AppData، فاز ۱۸۵ Month Intelligence مشتق‌شده و فاز ۱۸۶ Loading Shell پایدار و Route transition سازگار با Reduced Motion را اضافه می‌کند. جزئیات در [یادداشت Release ۲.۴.۰](./docs/releases/RELEASE_NOTES_2.4.0_FA.md)، [یادداشت فاز ۱۸۶](./docs/phases/PHASE_186_NOTES_FA.md) و [نقشه راه](./docs/roadmap/BACKLOG_FA.md) ثبت شده‌اند.
