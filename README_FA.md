...
Baseline فاز ۱۷۸ روی `887158c` با **۷۵۸/۷۵۸ تست** بسته شد. Candidate فاز ۱۷۹ روی `1cabdb4` Gate **۷۶۴/۷۶۴** را کامل کرد و فاز ۱۸۰ با شش قرارداد Finalization به Gate نهایی **۷۷۰/۷۷۰** رسید. قرارداد منتشرشده ۲.۴.۰ به‌صورت immutable روی Schema v17 باقی می‌ماند. توسعه پس از Release اکنون برای Flexible Work/Activity Segments و Notification Intelligence روی **Schema v19** است. فاز ۱۸۴ بدون تغییر AppData، Product Analytics privacy-safe و Opt-in اضافه می‌کند: Consent فقط روی همان Browser می‌ماند، Propertyها Allowlist هستند و تا Provider build-time + اجازه صریح کاربر هیچ Analytics transport فعالی وجود ندارد. جزئیات در [یادداشت Release ۲.۴.۰](./docs/releases/RELEASE_NOTES_2.4.0_FA.md)، [یادداشت فاز ۱۸۴](./docs/phases/PHASE_184_NOTES_FA.md) و [نقشه راه](./docs/roadmap/BACKLOG_FA.md) ثبت شده‌اند.
